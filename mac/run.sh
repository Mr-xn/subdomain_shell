#./subfinder -d $1 -silent|sudo ./ksubdomain_mac -e 0 -verify -silent|./httpx -title -content-length -status-code
...
printf "请自行在使用这个脚本之前确定ksubdomain_mac列出来的你正在使用的外网网卡，比如 0 1 2 3 自信修改命令中的 -e 参数后的值"
...
ksubdomain_mac='sudo ./ksubdomain_mac -e 0 -verify -silent'
